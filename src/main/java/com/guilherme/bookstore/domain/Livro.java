...
public class Livro implements Serializable {
	...
	@Length(min = 3, max = 50, message = "O campo TÍTULO deve conter entre 3 e 50 caracteres")
	...
	@Length(min = 10, max = 2000000, message = "O campo TEXTO deve conter entre 10 e 2.000.000 caracteres")
